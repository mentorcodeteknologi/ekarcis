                ...
                <div class="xxmd:w-2/3 xmd:w-full xxsm:w-full">
                    ...
                    <div class="mt-8 pb-5 bg-white shadow-lg rounded-md">
                        <div
                            ...
                            <a
                                href="{{ route('organizationDetails', ['id' => $data->organization->id, 'name' => $data->organization->name ?? $data->organization->first_name]) }}">
                                <div class="flex msm:flex-wrap xxsm:flex-wrap">
                                    ...
                                    <div class="ml-3">
                                        <p class="font-poppins font-normal text-base leading-6 text-gray">
                                            {{ $data->organization->name ? $data->organization->name : $data->organization->first_name . ' ' . $data->organization->last_name }}</p>
